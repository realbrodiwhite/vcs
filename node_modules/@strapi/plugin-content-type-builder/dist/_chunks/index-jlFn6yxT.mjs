...
const ListView$1 = lazy(() => import("./ListView-LnhZ3ksq.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-LnhZ3ksq.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-jlFn6yxT.mjs.map
