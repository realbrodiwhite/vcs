...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-yRyOfi01.mjs";
import sortBy from "lodash/sortBy";
import { useSelector } from "react-redux";
import { s as selectAdminPermissions } from "./AuthenticatedApp-p_Hoz4w0.mjs";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-wqvQZos7.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-oOPktA3S.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-eh67IoKV.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-CbpEmXk3.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-JIwwNmac.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-JS93HO0g.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-CXHGEXMF.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-H51hPwcO.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-hFe-nYXL.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-07uZxF2i.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-hFjKdwYu.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-qJ7nFINE.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-8a8sE0PN.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-BHlcoKKy.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-lgBWjHOT.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-0PZPHqsd.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-oGpvjQcC.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-LJF4HQu3.mjs.map
