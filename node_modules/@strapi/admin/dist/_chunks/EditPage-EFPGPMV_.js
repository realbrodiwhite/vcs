...
const useWebhooks = require("./useWebhooks-rkAK3kK5.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable--TwAHLZA.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-EFPGPMV_.js.map
