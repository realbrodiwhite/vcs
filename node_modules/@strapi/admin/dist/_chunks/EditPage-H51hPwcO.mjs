...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-yRyOfi01.mjs";
...
import { u as useWebhooks } from "./useWebhooks-GBt4UUQt.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-Fvc-JpRm.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-H51hPwcO.mjs.map
